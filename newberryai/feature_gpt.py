...
class FeatureGptSummarizer:
    """
    AI-powered document summarization using GPT-4o (GptAgent).
    """
    def __init__(self):
    ...
    def start_gradio(self):
        self.assistant.launch_gradio(
            title="GPT-4o Document Summarizer",
            description="Extract and summarize your document with GPT-4o",
    ...
    def run_cli(self):
        print("GPT-4o Document Summarizer AI Assistant initialized")
...
class FeatureGptChat:
    """
    AI-powered chat assistant using GPT-4o (GptAgent).
    """
    def __init__(self):
    ...
    def start_gradio(self):
        ...
        def gradio_callback(query):
            try:
                ...
                return f"Error: {e}"
        with gr.Blocks(title="GPT-4o Chat Assistant") as iface:
            gr.Markdown("# GPT-4o Chat Assistant")
    ...
    def run_cli(self):
        print("GPT-4o Chat Assistant initialized")
        print("Type 'exit' or 'quit' to end the conversation.")
        while True:
            user_input = input("\nYou: ")
            if user_input.lower() in ["exit", "quit"]:
...
class FeatureGptImage:
    """
    AI-powered image analysis using GPT-4o (GptAgent).
    """
    def __init__(self):
    ...
    def start_gradio(self):
        self.assistant.launch_gradio(
            title="GPT-4o Image Analyzer",
            description="Upload an image and get a detailed analysis with GPT-4o.",
    ...
    def run_cli(self):
        print("GPT-4o Image Analyzer initialized")
        print("Type 'exit' or 'quit' to end the conversation.")
        while True:
...
class FeatureGptAgent:
    """
    AI-powered agent for reasoning and task execution using GPT-4o (GptAgent).
    """
    def __init__(self):
    ...
    def start_gradio(self):
        ...
        def gradio_callback(text, file):
            try:
                ...
                return self.ask(question=text, file_path=file.name if file else None)
            except Exception as e:
                return f"Error: {e}"

        with gr.Blocks(title="GPT-4o Agent") as iface:
            gr.Markdown("# GPT-4o Agent")
            with gr.Row():
    ...
    def run_cli(self):
        print("GPT-4o Agent initialized")
        print("Type 'exit' or 'quit' to end the conversation.")
        while True:
